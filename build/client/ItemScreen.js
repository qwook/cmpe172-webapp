...
var ItemScreen = function (_React$Component) {
  ...
  function ItemScreen(...args) {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (ItemScreen.__proto__ || Object.getPrototypeOf(ItemScreen)).call(this, ...args)), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
  }
